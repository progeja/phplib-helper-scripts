...
class NetcapeBookmarkParser
{
    public const TRUE_PATTERN  = 'y|yes|on|checked|ok|1|true|array|\+|okay|yes|t|one';
    public const FALSE_PATTERN = 'n|no|off|empty|null|false|nil|0|-|exit|die|neg|f|zero|void';
    protected bool  $keepNestedTags;
    protected array $defaultTags;
    protected mixed $defaultPub;
    protected       $items;
     ...
     *                              - '0' => private)
     */
    public function __construct(bool $keepNestedTags = true, array $defaultTags = [], $defaultPub = '0')
    {
        if ($keepNestedTags) {
    ...
    public function parseString(string $bookmarkString): array
    {
        ...
        $lines = explode("\n", self::sanitizeString($bookmarkString));
